<template>
  <sidenav :orientation="orientation" :class="curClasses">
    ...
    <div class="app-brand demo" v-if="orientation !== 'horizontal'">
      ...
      <router-link to="/" class="app-brand-text demo sidenav-text font-weight-normal ml-2">外卖总后台</router-link>
    ...
    <div class="sidenav-inner" :class="{ 'py-1': orientation !== 'horizontal' }">
      ...
      <!--<sidenav-menu icon="ion ion-md-speedometer" :active="isMenuActive('/dashboards')" :open="isMenuOpen('/dashboards')">-->
        ...
        <!--<sidenav-router-link to="/dashboards/dashboard-1" :exact="true">用户信息</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-2" :exact="true">订单管理</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-3" :exact="true">优惠管理</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-4" :exact="true">收藏管理</sidenav-router-link>-->
      <!--</sidenav-menu>-->
      <!--&lt;!&ndash; 商铺管理 &ndash;&gt;-->
      <!--<sidenav-menu icon="ion ion-ios-albums" :active="isMenuActive('/dashboards')" :open="isMenuOpen('/dashboards')">-->
        <!--<template slot="link-text">商铺管理</template>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-1" :exact="true">店铺信息</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-2" :exact="true">新增商家</sidenav-router-link>-->
      <!--</sidenav-menu>-->
      <!--&lt;!&ndash; 订单管理 &ndash;&gt;-->
      <!--<sidenav-menu icon="ion ion-md-quote" :active="isMenuActive('/dashboards')" :open="isMenuOpen('/dashboards')">-->
        <!--<template slot="link-text">订单管理</template>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-1" :exact="true">用户信息</sidenav-router-link>-->
      <!--</sidenav-menu>-->
      <!--&lt;!&ndash; 推荐管理 &ndash;&gt;-->
      <!--<sidenav-menu icon="ion ion-md-switch" :active="isMenuActive('/dashboards')" :open="isMenuOpen('/dashboards')">-->
        <!--<template slot="link-text">推荐管理</template>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-1" :exact="true">美味上新</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-2" :exact="true">热销商品</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-3" :exact="true">发现</sidenav-router-link>-->
      <!--</sidenav-menu>-->
      <!--&lt;!&ndash; 系统设置 &ndash;&gt;-->
      <!--<sidenav-menu icon="ion ion-ios-heart" :active="isMenuActive('/dashboards')" :open="isMenuOpen('/dashboards')">-->
        <!--<template slot="link-text">系统设置</template>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-1" :exact="true">偏好标签管理</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-2" :exact="true">退款处理</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-2" :exact="true">意见反馈</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-2" :exact="true">在线客服</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-3" :exact="true">密码管理</sidenav-router-link>-->
        <!--<sidenav-router-link to="/dashboards/dashboard-3" :exact="true">轮播图管理</sidenav-router-link>-->
      <!--</sidenav-menu>-->
      <!-- Dashboards -->
      <sidenav-menu icon="ion ion-md-speedometer" :active="isMenuActive('/dashboards')" :open="isMenuOpen('/dashboards')">
